...
export const EMBEDDED_COMMENT_BRIDGE_SCRIPT = [
  ...
  '      ".ec-hover-overlay,.ec-selection-outline,.ec-region-selection{position:fixed;border:2px solid #1683ff;background:rgba(22,131,255,0.06);pointer-events:none;z-index:2147483646;box-sizing:border-box}",',
  '      ".ec-selection-outline{background:rgba(22,131,255,0.03)}",',
  '      ".ec-region-selection{border-style:dashed;background:rgba(22,131,255,0.12)}",',
  ...
  "    var left = Math.max(0, Math.min(window.innerWidth, rect.x));",
  "    var top = Math.max(0, Math.min(window.innerHeight, rect.y));",
  "    var right = Math.max(left, Math.min(window.innerWidth, rect.x + rect.width));",
  "    var bottom = Math.max(top, Math.min(window.innerHeight, rect.y + rect.height));",
  ...
  "    }",
  "    positionSelectionOverlay(regionOverlay, rect);",
  "  }",
  "",
  ...
  "    }",
  "    positionSelectionOverlay(hoverOverlay, rect);",
  "  }",
  "",
  ...
  "    positionSelectionOverlay(selection, info.rect);",
