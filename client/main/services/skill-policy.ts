import {
  readMarlouesBuildEnv,
  type MarlouesBuildEnv,
...
export function getSkillRuntimePolicy(): SkillRuntimePolicy {
  ...
  return {
    env,
    ...base,
    allowLocalImport: readBooleanOverride(
      "MARLOUES_ALLOW_LOCAL_SKILL_IMPORT",
      base.allowLocalImport,
    ),
    allowMutableLocalSkills: readBooleanOverride(
      "MARLOUES_ALLOW_MUTABLE_SKILLS",
      base.allowMutableLocalSkills,
    ),
    verifyIntegrityOnRun: readBooleanOverride(
      "MARLOUES_SKIP_SKILL_INTEGRITY_CHECK",
      base.verifyIntegrityOnRun,
      {
        invert: true,
      },
    ),
